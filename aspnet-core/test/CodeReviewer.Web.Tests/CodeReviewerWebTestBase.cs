...
{
    public abstract class CodeReviewerWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CodeReviewerWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CodeReviewerWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<CodeReviewerDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<CodeReviewerDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CodeReviewerDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CodeReviewerDbContext, Task<T>> func)
        {
            T result;
